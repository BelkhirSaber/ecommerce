<!-- header -->
<header style="border-bottom: 1px solid #ccc; background-color: #03d79a;">

  <section class="p-3 pb-md-5 position-relative container-fluid container-xxl">
    <!-- navbar -->
      ...
      <div class="container-fluid justify-content-between">
        ...
        <div class="nav align-items-center justify-content-end">
          ...
          <div class="position-relative">
            ...
            <ul class="dropdown-menu end-0 dropdown-menu-end">
